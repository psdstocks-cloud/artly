    ...
    public static function render() {
        ...
        if ( isset( $_POST['nehtw_sites_nonce'] ) && wp_verify_nonce( $_POST['nehtw_sites_nonce'], 'nehtw_sites_save' ) ) {
            ...
            if ( ! empty( $payload ) ) {
                ...
                $notice = __( 'Sites updated.', 'nehtw-gateway' );
            }
        }
                        ...
                        <?php foreach ( $sites as $site ) : ?>
                            <tr>
                                <td>
                                    ...
                                    <div class="nehtw-chip nehtw-chip-<?php echo esc_attr( $site->status ); ?>">
                                        <?php echo esc_html( ucfirst( $site->status ) ); ?>
                                    </div>
                                    <div><code><?php echo esc_html( $site->site_key ); ?></code></div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <code><?php echo $site->regex_pattern ? esc_html( $site->regex_pattern ) : '—'; ?></code>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
