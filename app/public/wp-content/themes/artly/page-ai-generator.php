...
$ai_cost_generate = (int) get_option( 'artly_ai_cost_generate', 10 );
$ai_cost_vary     = (int) get_option( 'artly_ai_cost_vary', 6 );
$ai_cost_upscale  = (int) get_option( 'artly_ai_cost_upscale', 4 );
?>
