...
<main class="artly-front">
    ...
    <section class="artly-hero">
        <div class="artly-container artly-hero-inner">
            <div class="artly-hero-left">
                <p class="artly-eyebrow">Modern workspace for stock &amp; AI visuals</p>
                <h1 class="artly-hero-title">One wallet for every stock website</h1>
                <p class="artly-hero-sub">
                    Artly lets you buy points once and spend them across top stock sites. Paste a link, get the file, and keep
                    every download organised for your team — in Egypt and worldwide.
                </p>
                <div class="artly-hero-actions">
                    <a href="<?php echo esc_url( site_url( '/signup/' ) ); ?>" class="artly-btn artly-btn-primary">Start free in minutes</a>
                    <a href="<?php echo esc_url( site_url( '/pricing/' ) ); ?>" class="artly-btn artly-btn-ghost">View pricing</a>
                </div>
                <p class="artly-hero-meta">Pay in EGP or USD · Works with leading stock providers · Built for agencies, teams and freelancers</p>
            </div>
            <div class="artly-hero-right">
                <div class="artly-hero-console">
                    <div class="artly-hero-console-body">
                    ...
                    <div class="artly-hero-console-footer">Example workflow. Live orders available after sign-up.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="artly-section artly-pricing-teaser">
        <div class="artly-container">
            <div class="artly-pricing-inner">
                ...
                <a href="<?php echo esc_url( site_url( '/pricing/' ) ); ?>" class="artly-btn artly-btn-primary">Explore plans &amp; points</a>
            </div>
        </div>
    </section>
    ...
    <section class="artly-section artly-final-cta">
        <div class="artly-container">
            <div class="artly-final-cta-inner">
                ...
                <div class="artly-final-cta-actions">
                    <a href="<?php echo esc_url( site_url( '/signup/' ) ); ?>" class="artly-btn artly-btn-primary">Get started free</a>
                    <a href="<?php echo esc_url( site_url( '/stock-order/' ) ); ?>" class="artly-btn artly-btn-ghost">Try link downloader</a>
                </div>
            </div>
        </div>
    </section>
